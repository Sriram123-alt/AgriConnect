    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 5000, display: 'flex', justifyContent: 'flex-end', overflow: 'hidden' }}>
            ...
            <div className="animate-slide-in-right" style={{
                ...
                {/* Modern Header for Transport App */}
                <div style={{
                    padding: '32px 24px',
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '13px', color: '#64748b', marginTop: '4px', margin: '4px 0 0' }}>Logistics and status updates</p>
                    </div>
                    <button
                        onClick={onClose}
                        style={{
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '12px' }}>
                    ...
                    {loading && notifications.length === 0 ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '100px 20px', color: '#94a3b8' }}>
                            ...
                            <h3 style={{ fontWeight: '700', color: '#1e293b', fontSize: '16px', marginBottom: '8px' }}>Logistics clear</h3>
                            <p style={{ fontSize: '13px', lineHeight: '1.5' }}>No new logistical alerts.</p>
                        </div>
                    ) : (
                                ...
                                return (
                                    <div
                                        ...
                                        onMouseEnter={e => {
                                            ...
                                            const dBtn = e.currentTarget.querySelector('.delete-btn');
                ...
                <div style={{ padding: '20px', borderTop: '1px solid #f1f5f9', background: '#ffffff', textAlign: 'center' }}>
                    <p style={{ fontSize: '12px', color: '#64748b', fontWeight: '500', margin: 0 }}>Showing your logistics flow</p>
                </div>
            </div>
        </div>
    );
